...
import { Shield, Mail, Lock, AlertCircle, Loader2, ArrowLeft, CheckCircle } from "lucide-react";
    ...
    return (
        <div className="relative w-full max-w-md px-4 animate-fade-in">
            ...
            <div className="glass-card p-8">
                ...
                {registered && (
                    <div className="flex items-center gap-2 bg-green-500/10 border border-green-500/30 text-green-400 rounded-lg px-4 py-3 mb-5 text-sm">
