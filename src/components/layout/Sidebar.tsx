...
export default function Sidebar({ user }: SidebarProps) {
    ...
    return (
        <aside className="w-60 bg-[#0b1120] border-r border-slate-800 flex flex-col shrink-0">
            {/* Logo */}
            <div className="h-16 flex items-center px-5 border-b border-slate-800">
                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center mr-3 shadow shadow-blue-600/30">
                    <Shield className="w-4.5 h-4.5 text-white" />
                </div>
                <div>
                    <p className="text-sm font-bold text-white leading-tight">ImportCompliance</p>
